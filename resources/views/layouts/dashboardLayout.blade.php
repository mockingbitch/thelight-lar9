...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link {{$breadcrumb == DashboardConstant::BREADCRUMB['home'] ? 'active' : ''}}" href="{{route(RouteConstant::DASHBOARD['home'])}}">
        ...
        <li class="nav-item">
          <a class="nav-link {{$breadcrumb == DashboardConstant::BREADCRUMB['category'] ? 'active' : ''}}" href="{{route(RouteConstant::DASHBOARD['category_list'])}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link {{$breadcrumb == DashboardConstant::BREADCRUMB['table'] ? 'active' : ''}}" href="{{route(RouteConstant::DASHBOARD['table_list'])}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link {{$breadcrumb == DashboardConstant::BREADCRUMB['bill'] ? 'active' : ''}}" href="{{route(RouteConstant::DASHBOARD['bill_list'])}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <li class="nav-item">
          <a class="nav-link {{$breadcrumb == DashboardConstant::BREADCRUMB['user'] ? 'active' : ''}}" href="{{route(RouteConstant::DASHBOARD['user_list'])}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
